...
const { academicAssistant, generateFeedback, checkPlagiarism, suggestIdeas, reviewProposal, generateProposalOutline, generateProjectReportDraft, recommendTask, getInteractions, rateInteraction, getStatus, humanizeText } = require('../controllers/aiController');
