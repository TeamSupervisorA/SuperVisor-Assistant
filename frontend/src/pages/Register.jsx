          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <input className="w-full rounded border-outline-variant bg-surface-container-lowest text-on-surface focus:border-primary focus:ring-1 focus:ring-primary shadow-sm px-4 py-2.5 transition-shadow" id="fullName" placeholder="Dr. Jane Doe" type="text" required value={form.fullName} onChange={handleChange} />
              </div>
              <div className="space-y-2">
                ...
                <input className="w-full rounded border-outline-variant bg-surface-container-lowest text-on-surface focus:border-primary focus:ring-1 focus:ring-primary shadow-sm px-4 py-2.5 transition-shadow" id="idNumber" placeholder="e.g. 2024-001" type="text" value={form.idNumber} onChange={handleChange} />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <input className="w-full rounded border-outline-variant bg-surface-container-lowest text-on-surface focus:border-primary focus:ring-1 focus:ring-primary shadow-sm px-4 py-2.5 transition-shadow" id="email" placeholder="jane.doe@university.edu" type="email" required value={form.email} onChange={handleChange} />
              </div>
              <div className="space-y-2">
                <label className="block font-label-md text-[12px] font-semibold text-on-surface-variant" htmlFor="role">Role</label>
                <div className="relative">
                  <select className="w-full rounded border-outline-variant bg-surface-container-lowest text-on-surface focus:border-primary focus:ring-1 focus:ring-primary shadow-sm px-4 py-2.5 appearance-none transition-shadow" id="role" required value={form.role} onChange={handleChange}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <input className="w-full rounded border-outline-variant bg-surface-container-lowest text-on-surface focus:border-primary focus:ring-1 focus:ring-primary shadow-sm px-4 py-2.5 transition-shadow" id="department" placeholder="e.g. Computer Science" type="text" value={form.department} onChange={handleChange} />
              </div>
              <div className="space-y-2">
                ...
                <input className="w-full rounded border-outline-variant bg-surface-container-lowest text-on-surface focus:border-primary focus:ring-1 focus:ring-primary shadow-sm px-4 py-2.5 transition-shadow" id="batch" placeholder="e.g. Fall '24 or Assoc. Prof" type="text" value={form.batch} onChange={handleChange} />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <input className="w-full rounded border-outline-variant bg-surface-container-lowest text-on-surface focus:border-primary focus:ring-1 focus:ring-primary shadow-sm px-4 py-2.5 transition-shadow" id="password" placeholder="••••••••" type="password" required value={form.password} onChange={handleChange} />
              </div>
              <div className="space-y-2">
                ...
                <input className="w-full rounded border-outline-variant bg-surface-container-lowest text-on-surface focus:border-primary focus:ring-1 focus:ring-primary shadow-sm px-4 py-2.5 transition-shadow" id="confirmPassword" placeholder="••••••••" type="password" required value={form.confirmPassword} onChange={handleChange} />
              </div>
            </div>

            <div className="pt-4">
              <button className="w-full bg-primary hover:bg-surface-tint text-on-primary font-title-lg text-[20px] font-semibold py-3 px-4 rounded transition-colors duration-200 shadow-[0px_4px_6px_-1px_rgba(0,0,0,0.05),_0px_2px_4px_-2px_rgba(0,0,0,0.05)] flex justify-center items-center gap-2 disabled:opacity-60 disabled:cursor-not-allowed" type="submit" disabled={loading}>
