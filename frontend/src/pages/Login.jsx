    ...
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-background">
      ...
      <div className="relative z-10 w-full max-w-[1200px] px-6 py-12 flex flex-col items-center">
        ...
        <motion.div 
          ...
          className="mb-10 flex h-14 w-[260px] items-center justify-center rounded-2xl border border-outline-variant/35 bg-white px-4 py-2.5 shadow-lg shadow-primary/10 dark:border-white/10 dark:bg-[#11131a] dark:shadow-primary/15"
        >
