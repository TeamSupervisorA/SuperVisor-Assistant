      ...
      <main className="relative z-10 w-full max-w-[440px] px-margin_mobile md:px-0">
        <div className="bg-surface-container-lowest rounded-[24px] shadow-academic border-l-[2px] border-primary p-8 relative overflow-hidden">
          ...
          <form className="space-y-6">
            ...
            <button className="w-full bg-primary hover:bg-surface-tint text-on-primary font-title-lg text-[20px] font-semibold py-3 rounded-lg transition-colors duration-200 mt-2 flex items-center justify-center gap-2" type="submit">
              Login
