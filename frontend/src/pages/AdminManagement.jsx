...
const AdminManagement = () => {
  ...
  const assignSupervisor = async (project) => {
    ...
    try {
      ...
      setNotice(`Supervisor allocation saved for “${project.title}”. Project access and invitations were synchronized.`);
      await load();
    } catch (error) { setMessage(error.message); } finally { setBusyId(''); }
  };
